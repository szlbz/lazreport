...
var
  S1, S2, S3, S: String;
begin
  if AFontName='仿宋' Then AFontName:='FangSong' else
  if AFontName='楷体' Then AFontName:='KaiTi' else
  if AFontName='幼圆' Then AFontName:='YouYuan' else
  if AFontName='黑体' Then AFontName:='SimHei' else
